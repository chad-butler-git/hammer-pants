...
**Severity Breakdown:** 0 Critical, 14 High, 8 Medium, 1 Low
...
**Suggested Fix:** npm install jest@latest (upgrade parent)
...
**Dependency Chain:** grocery-infra → jest → @jest/core → jest-runtime → glob → minimatch
...
**Dependency Chain:** grocery-shared → jest → @jest/core → jest-runtime → glob → minimatch
...
**Dependency Chain:** grocery-shared → jest → @jest/core → jest-util → picomatch
...
**Dependency Chain:** grocery-api → jest → @jest/core → micromatch → picomatch
...
**Dependency Chain:** grocery-infra → jest → @jest/core → jest-util → picomatch
...
**Dependency Chain:** grocery-shared → jest → @jest/core → jest-runtime → glob → minimatch → brace-expansion
...
**Dependency Chain:** grocery-infra → jest → @jest/core → jest-runtime → glob → minimatch → brace-expansion
