# minimatch - Vulnerability Details

**Package to Upgrade:** `minimatch`

**Total Vulnerabilities:** 6

**Severity Breakdown:** 0 Critical, 6 High, 0 Medium, 0 Low
...
These vulnerabilities are in transitive dependencies. Upgrade `minimatch` in package.json to fix them.
...
**Dependency Chain:** root → minimatch
...
**Suggested Fix:** npm install minimatch@latest (upgrade parent)
