...
These vulnerabilities are in transitive dependencies. Upgrade `vite` in package.json to fix them.
...
**Dependency Chain:** root → vite → rollup
...
**Direct Upgrade:** `npm install rollup@2.80.0` (adds as direct dependency)

**Suggested Fix:** npm install vite@latest (upgrade parent)
